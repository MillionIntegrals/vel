...
class TrainPhase:
    ...
    def set_up_phase(self, training_info: TrainingInfo, model: Model, loader: DatasetLoader) -> VelOptimizer:
    ...
    def execute_epoch(self, epoch_info: EpochInfo, trainer: Trainer):
        """
