...
class ReplayQEnvRoller(ReplayEnvRollerBase):
    ...
    def rollout(self, batch_info, model):
        ...
        return {
            ...
            'action_logits': action_logit_buffer.reshape(
                (action_logit_buffer.size(0) * action_logit_buffer.size(1), action_logit_buffer.size(2))
            ),
